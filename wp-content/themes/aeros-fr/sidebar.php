 ...
 <li style="margin-top:0px;">
   <form id="searchform" method="get" action="<?php bloginfo('home'); ?>">
        <div>
                ...
                <input type="image" src="<?php bloginfo('url'); ?>/wp-content/themes/aeros-fr/images/lens.png" title="chercher" alt="S" style="margin:0 0 -5px 3px;" />
        </div>
        </form>
 </li>
</ul>
...
<?php         /* Widgetized sidebar, if you have the plugin installed. */
        ...
        <?php wp_list_categories('title_li=<h3>' . __('Catégories :') . '</h3>' ); ?>
